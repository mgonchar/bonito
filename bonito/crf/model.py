...
from .decode import CTC_CRF_Torch as CTC_CRF
...
class SeqdistModel(Module):
    def __init__(self, encoder, seqdist, n_pre_post_context_bases=None, target_projection=None, **kwargs):
        super().__init__()
    ...
    def from_dict(cls, model_dict, layer_types=None):
        ...
        kwargs = dict(
            ...
            seqdist=CTC_CRF(**model_dict["seqdist"], device = device),
        )
        return cls(**kwargs)
